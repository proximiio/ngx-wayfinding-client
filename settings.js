var Settings = {
  ...
  basepath: "/maria01", // in case of change it's required to change that also at ./src/environments and ./angular.json files
  port: "6003", // in case of change it's required to change that also at ./src/environments
